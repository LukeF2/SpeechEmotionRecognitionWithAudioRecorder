...
# Define the correct paths for actor folders
ACTOR_25_PATH = os.path.join(TRAINING_FILES_PATH, 'Actor_25')
ACTOR_26_PATH = os.path.join(TRAINING_FILES_PATH, 'Actor_26')

# Ensure the directories exist
os.makedirs(ACTOR_25_PATH, exist_ok=True)
os.makedirs(ACTOR_26_PATH, exist_ok=True)
